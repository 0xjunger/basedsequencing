...
- [Based rollups — superpowers from L1 sequencing | Justin Drake](https://ethresear.ch/t/based-rollups-superpowers-from-l1-sequencing/15016)
- [Ethereum L1 as a shared sequencer with preconfirmations | Justin Drake](https://notes.ethereum.org/WLuNFaliQiqw7Zhd-7AnmQ?view)
- [Based Rollup FAQ | Taiko](https://taiko.mirror.xyz/7dfMydX1FqEx9_sOvhRt3V8hJksKSIWjzhCVu7FyMZU)
- [Collaborative Based Rollups | AztecLabs](https://forum.aztec.network/t/collaborative-based-rollups/5227)
- [Based Rollups | AztecLabs](https://docs.google.com/presentation/d/1c3mVl0uHj47HmlAOMHoJ9xhOiC7oYmMUlCZeHikH5KA/edit#slide=id.p)
- [Based Rollup Thesis | Sacha](https://hackmd.io/@sacha/based-rollup-thesis)
- [Based Espresso | Espresso](https://hackmd.io/@EspressoSystems/BasedEspresso)
...
- [Based rollups and decentralized sequencing part 1 | Taiko Spaces](https://www.youtube.com/watch?v=eS5s08sgjuo)
- [Based rollups and decentralized sequencing part 2 | Taiko Spaces](https://www.youtube.com/watch?v=RqgIEkAfpks)
...
- [Preconfirmations Glossary & Requirements | George Spasov](https://hackmd.io/5JKov8o7SKS9d7sKQLd45Q)
- [Preconfirmations: The Fulfillment-Delivery Paradigm | Primev](https://mirror.xyz/preconf.eth/sgcuSbd1jgaRXj9odSJW-_OlWIg6jcDREw1hUJnXtgI)
- [Censorship, Latency, and Preconfirmations in the Blob Market | Primev](https://mirror.xyz/preconf.eth/cxUO8pPBfqnqAlzFUzoEUa6sgnr68DRmsNhBWPb2u-c)
- [Analyzing BFT & Proposer-Promised Preconfirmations | Ellie Davidson](https://ethresear.ch/t/analyzing-bft-proposer-promised-preconfirmations/17963)
- [L1 Interop and Finality Tradeoffs | Ellie Davidson](https://docs.google.com/presentation/d/1QWJbxkDmGcHo2Qa_gpWoMd4XEOE8LQnnHnLOB0VTYyA/edit#slide=id.g1f2a61fc6a7_0_321)
- [Blob Preconfirmations with Inclusion Lists to Mitigate Blob Contention and Censorship | Christian Matt](https://ethresear.ch/t/blob-preconfirmations-with-inclusion-lists-to-mitigate-blob-contention-and-censorship/19150)
- [Exploring the preconfirmation delegator model | Jonas 'mempirate'](https://hackmd.io/5JKov8o7SKS9d7sKQLd45Q)
...
- [Pre-confirmations & interop deep dive | BellCurvePodcast](http://youtu.be/QpJm0IO_foU)
